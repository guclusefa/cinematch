<template>
  <div
    class="bg-white rounded overflow-hidden shadow hover:shadow-xl transition duration-300 h-full flex flex-col"
  >
    <img
    ...
    <div class="p-4 flex flex-col flex-grow">
      ...
      <!-- Limit the number of lines for the overview to avoid overflow -->
      <p class="text-gray-700 text-sm line-clamp-3 flex-grow">{{ props.movie.overview }}</p>

      <!-- Buttons for "Watched" and "Liked" -->
...
// Import Heroicons for outline and solid variants
...
// State for "Watched" and "Liked" toggles
